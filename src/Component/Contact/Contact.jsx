...
const Contact = () => {
    return (
        <div className="w-full bg-style">
            <h1 className="text-orange-600 text-4xl font-bold pt-5">Contact Us</h1>
                        ...
                        <div className="md:flex items-center mt-12 text-left">
                            <div className="w-full md:w-1/2 flex flex-col">
                                ...
                                <input
                                    type="text"
                                    name="name"
                                    className="leading-none text-gray-50 p-3 focus:outline-none focus:border-orange-600 mt-4 border-0 bg-gray-800 rounded"
                                    required
                                />
                            </div>
                        ...
                        <div className="text-left">
                            <div className="w-full flex flex-col mt-8">
                                ...
                                <textarea
                                    type="text"
                                    name="message"
                                    className="h-40 text-base leading-none text-gray-50 p-3 focus:outline-none focus:border-orange-600 mt-4 bg-gray-800 border-0 rounded">
                                </textarea>
                            </div>
                        </div>
                        <div className="w-full">
                            <button className="mt-9 font-semibold leading-none text-white  border border-orange-600 py-4 px-6 bg-orange-600 rounded hover:bg-transparent focus:ring-0 focus:outline-none duration-300">
                                <FontAwesomeIcon icon={faPaperPlane} className="text-xl mr-4" />
                                Send message
                            </button>
                        </div>
                    </form>
